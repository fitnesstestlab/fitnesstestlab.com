...
<ol class="ol1">
 	<li class="li2"><span style="text-decoration: underline;"><strong>Increased comfort and safety</strong></span>: The BoS Open Trap Bar features a hexagonal design that centers the weight outside of the body instead of in front of the body, allowing for a more natural grip that reduces strain on the wrists and lower back. This makes the exercise safer, especially for those who are new to deadlifting or have had injuries in the past.</li>
 	<li class="li2"><strong><span style="text-decoration: underline;">Improved technique</span>:</strong> Using the BoS Open Trap Bar allows you to maintain a more upright position during the deadlift, which fosters more engagement of the glutes and hamstrings instead of over-reliance on the lower back muscles. This also helps to improve posture and decrease the risk of back injury.</li>
 	<li class="li2"><strong><span style="text-decoration: underline;">Greater versatility</span>:</strong> The design of the BoS Open Trap Bar allows for a wider range of exercises that can be performed with it, such as shrugs, farmer's walks, split-squats, and lunges. This allows for more variety in your training routine, making it a great addition to a home gym.</li>
 	<li><strong><span style="text-decoration: underline;">Great for limited mobility</span>:</strong> The Bells of Steel Open Trap Bar is an ideal solution for individuals with mobility issues who still want to maintain a deadlifting routine. The high handles on the trap bar provide a more mechanically favorable starting position and shorter range of motion, which can help to improve form and build strength in the hips and back. For those that want or need more range of motion by starting in a deeper stance, the bar can be flipped over to use the low handles instead.</li>
 	<li class="li2"><strong><span style="text-decoration: underline;">Ease of use</span>: </strong>The Bells of Steel Open Trap Bar is designed with a built-in deadlift jack, which makes loading and unloading the weight plates easy, efficient and less time-consuming. It also eliminates the need for one less piece of equipment, since I can now get rid of my stand-alone deadlift jack!</li>
</ol>
...
<p class="p1">Not all specialty bars are designed to work with Olympic-sized plates and collars, so the fact that the sleeves can accommodate Olympic plates and collars is a great bonus.</p>
...
The Eleiko <span class="font-bold text-h-2xl lg:text-h-3xl xl:text-h-4xl max-w-lg text-primary">Öppen Deadlift Bar comes to mind, as that was the first hex bar I ever saw that had an open design and a built-in deadlift jack. </span>
...
I've read reviews of other brands of trap bars stating that standard weight collars don't work with them, but I'm happy to say that my <a href="http://amzn.to/2wwgpnb">Lock-Jaw collars</a> work just fine with the Bells of Steel Open trap Bar.
...
<h3>Rotating sleeves and sleeve length</h3>
At 59 inches long, the Bells of Steel Open Trap Bar qualifies as a shorty barbell.

I'm fine with that, since I only use <a href="https://fitnesstestlab.com/best-short-olympic-bars/" target="_blank" rel="noopener">shorty bars</a> in the Lab to save on space.
...
<p class="p1">The trap bar 3.0 sleeves have 9.5 inches of loadable length, as opposed to 16 inches for a standard Olympic bar.</p>
